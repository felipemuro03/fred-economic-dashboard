...
CATALOGO = {
    ...
    "Inflação": [
        {"id": "CPIAUCSL", "nome": "Consumer Price Index for All Urban Consumers: All Items in U.S. City Average", "nota": "Mensal", "tipo": "indice", "destaque": True},
    ...
    "Emprego": [
        {"id": "UNRATE", "nome": "Unemployment Rate", "nota": "Mensal, %", "destaque": True},
    ...
    "Juros": [
        {"id": "FEDFUNDS", "nome": "Federal Funds Effective Rate", "nota": "Mensal, %", "destaque": True},
        {"id": "DGS10", "nome": "Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity", "nota": "Diário, %", "destaque": True},
    ...
    "Consumo": [
        {"id": "UMCSENT", "nome": "University of Michigan: Consumer Sentiment", "nota": "Mensal, nível do índice", "destaque": True},
    ...
    "Mercados": [
        {"id": "SP500", "nome": "S&P 500", "nota": "Diário, pontos", "destaque": True},
